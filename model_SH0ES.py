...
xp = np.zeros(L.shape[0])

Sinv_diag = np.zeros(L.shape[0])
...
print('Delta mu_N4258: ' + str(N4258_fit) + ' +/- ' + str(N4258_err))
print('-'*80)
...
plt.savefig('./plots_residual/residuals_SH0ES.png',dpi=300,bbox_inches='tight')
plt.close()
...
indlist = [46,37,39,40,38,41,43,42]
paramlabels = [r'$5 \log(H_0)$',r'$\Delta \mu_{\rm{N4258}}$',r'$\Delta \mu_{\rm{LMC}}$',r'$\mu_{\rm{M31}}$',r'$M_{H,1}^W$',r'$b_W$',r'$Z_W$',r'$M_{B}^{0}$']
...
plt.savefig('./plots_cornerplot/cornerplot_SH0ES.png',dpi=300,bbox_inches='tight')
plt.close()
